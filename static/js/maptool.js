    ...
    function initialize() {
        ...
        jQuery.get(url, {}, function(data) {
            ...
            jQuery(data).find("marker").each(function() {
                ...
                var marker_1 = new google.maps.Marker({position: latlng, map: map_canvas_1});
                var marker_2 = new google.maps.Marker({position: latlng, map: map_canvas_2});
                var marker_3 = new google.maps.Marker({position: latlng, map: map_canvas_3});
